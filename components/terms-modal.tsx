...
۵. کمپین سفیران
شرکت در برنامه سفیران داوطلبانه است. A Capital حق تغییر ساختار کمیسیون را با اطلاع‌رسانی قبلی دارد. پرداخت کمیسیون منوط به تأیید خرید توسط کاربر معرفی‌شده است.
