...
const founders = [
  {
    ...
    bio: 'علی برهان کارآفرین، تحلیلگر بازارهای مالی، مدرس سبک ICT و متخصص مدیریت سرمایه است. تمرکز اصلی او بر تحلیل جریان نقدینگی، مدیریت ریسک، رفتار بازار و طراحی استراتژی‌های سرمایه‌گذاری است.',
    fullBio: 'او همچنین در حوزه کارآفرینی، ساخت و توسعه کسب‌وکار، برندینگ و فروش فعال است و نگاه او فراتر از تحلیل بازار، به طراحی سیستم‌های اقتصادی و تجاری مقیاس‌پذیر گسترش دارد. پس از سال‌ها فعالیت در بازارهای مالی، ایده A | CAP را با هدف ایجاد یک سیستم هوشمند مدیریت سرمایه شخصی‌سازی‌شده بنیان‌گذاری کرد.',
  ...
  },
  {
    ...
    icon: Cpu,
    specialties: ['Full-Stack Development', 'هوش مصنوعی', 'محصولات دیجیتال', 'زیرساخت مقیاس‌پذیر'],
    bio: 'آرمان سعیدی کارآفرین، توسعه‌دهنده Full-Stack و متخصص فناوری‌های نوین، هوش مصنوعی و محصولات دیجیتال است.',
    fullBio: 'تمرکز او بر طراحی و توسعه زیرساخت‌های مقیاس‌پذیر، سیستم‌های هوشمند، اتوماسیون، تجربه کاربری و تبدیل ایده‌های پیچیده به محصولات قابل رشد است. او با ترکیب دانش فنی، توسعه محصول و نگاه رشد محور، نقش کلیدی در شکل‌گیری اکوسیستم A | CAP ایفا می‌کند.',
    responsibility: 'معماری فنی پلتفرم، توسعه ابزارهای هوشمند، سیستم‌های تحلیل داده، نوآوری محصول و هدایت مسیر تکنولوژی',
    color: '#60AFFF',
