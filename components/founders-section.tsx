...
const founders = [
  ...
  },
  {
    ...
    nameFA: 'آرمان سعیدی',
    role: 'Founder & CTO',
    roleFA: 'بنیان‌گذار و مدیر فناوری',
    icon: Cpu,
    specialties: ['Full-Stack Development', 'هوش مصنوعی', 'بازارهای مالی', 'محصولات دیجیتال'],
    bio: 'آرمان سعیدی بنیان‌گذار و مدیر فناوری A|CAP، کارآفرین، مدرس بازارهای مالی و متخصص هوش مصنوعی در معاملات است. بیش از ۵ سال سابقه در تحلیل تکنیکال، ارزهای دیجیتال و توسعه سیستم‌های معاملاتی هوشمند.',
