...
const faqs = [
  ...
  {
    q: 'برنامه سفیران چطور کار می‌کند؟',
    a: 'بعد از انجام تست شخصیت مالی، یک لینک اختصاصی دریافت می‌کنی. هرکس با لینک تو ثبت‌نام کند در آمارت ثبت می‌شود. در داشبورد می‌توانی تعداد بازدید، تست و خرید را جداگانه پیگیری کنی.',
  },
  {
