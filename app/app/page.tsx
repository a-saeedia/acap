...
export default function MergedDashboard() {
  ...
  if (!dashData || !session) return null
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-4" dir="rtl">
      {/* Welcome Header */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          >
            ...
            {!hasAssets ? (
              ...
              <>
                {/* Mini distribution + scan trigger */}
                <div className="flex items-center gap-4 mb-3">
                  <div className="shrink-0">
                    <svg width="80" height="80" viewBox="0 0 80 80">
                      ...
                      <text x="40" y="38" textAnchor="middle" className="fill-white text-[7px] font-bold">
                        {assets.length}
                      </text>
                      <text x="40" y="48" textAnchor="middle" className="fill-gray-400 text-[5px]">
                        دارایی
                      </text>
                    </svg>
                  </div>
        ...
        {/* Right: Quick actions, prices, profile */}
      ...
      {/* Portfolio Advisor Modal (توزیع مالی) */}
      <AnimatePresence>
        {showAdvisor && (
          <motion.div
            initial={{ opacity: 0 }}
